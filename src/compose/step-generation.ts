...
import { CompositionStep, CompositionStepAction } from './composition-steps';
...
function compareServicesForUpdate(
	...
	const targetServiceIds = _.map(target, 'serviceId');
	const currentServiceIds = _.map(current, 'serviceId');
	...
	const alreadyStarted = (serviceId: number) =>
		...
		// TODO: Some method of asking information about the
		// current started containers
}
